...
using NHibernate.SQLServer.Test.Mappings;
    ...
    class Program
    {
        static void Main()
        {
            ...
            using (var session = sessionFactory.OpenSession())
            {
                ...
                Console.WriteLine("Yahoo! The running is succeed!");
            }
        ...
        {
            var ds = SQLServerDataSource.createDefaultSqlDatasource();
            return Fluently.Configure()
                .Database(MsSqlConfiguration.MsSql2012.ConnectionString(c =>
                                    c.Server(ds.ServerName)
